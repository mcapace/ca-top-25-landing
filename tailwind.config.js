  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'elegant-lg': '0 16px 48px rgba(0, 0, 0, 0.15), 0 4px 16px rgba(0, 0, 0, 0.1)',
        'elegant-xl': '0 24px 64px rgba(0, 0, 0, 0.18), 0 8px 24px rgba(0, 0, 0, 0.12)',
        'champagne-glow': '0 0 24px rgba(236, 197, 95, 0.25)',
        'platinum-glow': '0 0 24px rgba(113, 113, 122, 0.2)',
